...
ActiveRecord::Schema.define(version: 2019_03_15_154615) do
  ...
  create_table "figures", force: :cascade do |t|
    ...
    t.index ["nick"], name: "index_figures_on_nick", unique: true
    t.index ["world_id"], name: "index_figures_on_world_id"
  end
  ...
  add_foreign_key "figures", "worlds"
